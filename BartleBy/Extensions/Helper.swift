...
class Helper {
    ...
    static func generateUserID() -> String {
        ...
        var randomIdWithoutDash = String((0..<32).map{ _ in letters.randomElement()! })
        
        randomIdWithoutDash.insert("-", at: randomIdWithoutDash.index(randomIdWithoutDash.startIndex, offsetBy: 8))
        randomIdWithoutDash.insert("-", at: randomIdWithoutDash.index(randomIdWithoutDash.startIndex, offsetBy: 13))
        randomIdWithoutDash.insert("-", at: randomIdWithoutDash.index(randomIdWithoutDash.startIndex, offsetBy: 18))
        randomIdWithoutDash.insert("-", at: randomIdWithoutDash.index(randomIdWithoutDash.startIndex, offsetBy: 23))
        
        return randomIdWithoutDash
    }
}
...
extension ProcessInfo {
    var iOSVersionNumber: String? {
        let os = self.operatingSystemVersion
        return String(os.majorVersion) + "_" + String(os.minorVersion) + "_" + String(os.patchVersion)
    }
}
